...
import StackExplorerPanel      from './views/StackExplorer';
...
export default {
  ...
  stopSession() {
    ...
    if (this.stackExplorer) this.stackExplorer.destroy();
  ...
  initViews() {
    ...
    this.stackExplorer = new StackExplorerPanel();
  },
