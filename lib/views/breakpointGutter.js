...
/**
  ...
  TODO: after stopping a debug session and then starting a new one w/
    the same editor in open, it will retain it's breakpoint markers
    even though there aren't any breakpoints set
**/
