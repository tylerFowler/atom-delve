...
import GoroutinePanel from './goroutinePanel';
...
export default class StackExplorerPanel {
  constructor() {
    ...
    this.goroutinePnl = new GoroutinePanel();
  ...
  render() {
    ...
    $explorerContainer.appendChild(this.goroutinePnl.getElement());
  ...
  updateState() {
    this.stacktracePnl.update(StateStore.getStacktrace());
    this.goroutinePnl.update(StateStore.getGoroutines());
  }
